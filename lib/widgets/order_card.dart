...
class OrderCard extends StatelessWidget {
  ...
  final List<String>? separateItemQuantities;

  OrderCard({
    this.itemCount,
    this.data,
    this.orderId,
    this.separateItemQuantities,
    });
      ...
      child: Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context , index){
              ...
              return placedOrderDesignWidget(model, context, separateItemQuantities![index]);
            }
        ),
      ),
    );
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(child: Text(model.title! ,style: const TextStyle(color:Colors.black , fontSize: 16 ,),)),
                    const SizedBox(width: 10,),
                    const Text("\$" ,style: TextStyle(color:Colors.black , fontSize: 16 ,),),
                    Text(model.price.toString(),style: TextStyle(color:Colors.black , fontSize: 16 ,),),
